...
ArrayList currentList1, currentList2,checkList, currentList;
Screen screen1, screen2,screen3, screen;
...
void setup() {
 ...
 // screen1.addWidget(forward);
  screen1.addWidget(new Checkbox((SCREENX-WIDGET_WIDTH)/2, SCREENY/2, WIDGET_WIDTH, WIDGET_HEIGHT, "Backward", 255, stdFont, BACKWARD));
//  screen1.addCheckbox(new Checkbox((SCREENX-WIDGET_WIDTH)/2, SCREENY/2, WIDGET_WIDTH, WIDGET_HEIGHT, "Backward", 255, stdFont, BACKWARD));
 ...
 checkList.add(new Checkbox((SCREENX-WIDGET_WIDTH)/2, SCREENY/2, WIDGET_WIDTH, WIDGET_HEIGHT, "Backward", 255, stdFont, CHECKED));
